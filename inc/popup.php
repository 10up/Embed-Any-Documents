			...
			<div class="ead-container">
				<form action="" onSubmit="return false" method="post" enctype="multipart/form-data" id="docuploader">
					<ul class="ead-options">
						<li>
							<a href="#" id="upload-doc"><span><img src="<?php echo $this->plugin_url; ?>images/icon-upload.png" alt="Upload document"/><?php _e( 'Upload Document', $this->text_domain ); ?></span></a>
						</li>
						<li>
							<a href="#" id="add-ead-document"><span><img src="<?php echo $this->plugin_url; ?>images/icon-link.png" alt="Add From URL"/><?php _e( 'Add from URL', $this->text_domain ); ?></span></a>
						</li>
			...
			<div class="upload-success">
				...
				<div class="advanced-options">
					...
					<ul class="option-fields">
						<li>
							<div class="f-left"><label><?php _e( 'Width', $this->text_domain ); ?></label>
								<input type="text" name="width" class="embedval input-small" id="ead-width" value="<?php echo get_option( 'ead-width', '100%' ); ?>">
							</div>
							<div class="f-left"><label><?php _e( 'Height', $this->text_domain ); ?></label>
