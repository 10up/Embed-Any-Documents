		...
		<div class="clearfix row-col">
			<div class="col-2">
				<a href="https://wordpress.org/support/view/plugin-reviews/embed-any-document#postform" target="_blank">
					<img src="<?php echo $this->plugin_url; ?>images/star.gif"><?php _e( 'Like the plugin?', 'embed-any-document' ); ?>
					<br/><?php _e( 'Rate Now!', 'embed-any-document' ); ?>
				</a>
			</div>
			<div class="col-2">
				<a href="http://awsm.in/support" target="_blank">
					<img src="<?php echo $this->plugin_url; ?>images/ticket.gif"><?php _e( 'Need Help?', 'embed-any-document' ); ?>
					<br/><?php _e( 'Open a Ticket', 'embed-any-document' ); ?>
				</a>
			</div>
		</div>
		<div class="ead-right-inner">
			...
			<ol>
				<li>
					<a href="http://awsm.in/ead-plus-documentation/#embedding" target="_blank" title="<?php _e( 'How to Embed Documents?', 'embed-any-document' ); ?>"><?php _e( 'How to Embed Documents?', 'embed-any-document' ); ?></a>
				</li>
				<li>
					<a href="http://awsm.in/ead-plus-documentation/#viewers" target="_blank" title="<?php _e( 'About Viewers', 'embed-any-document' ); ?>"><?php _e( 'About Viewers', 'embed-any-document' ); ?></a>
				</li>
				<li>
					<a href="http://awsm.in/ead-plus-documentation/#shortcode" target="_blank" title="<?php _e( 'Shortcode & Attributes', 'embed-any-document' ); ?>"><?php _e( 'Shortcode & Attributes', 'embed-any-document' ); ?></a>
				</li>
				<li>
					<a href="http://awsm.in/support" target="_blank" title="<?php _e( 'FAQs', 'embed-any-document' ); ?>"><?php _e( 'FAQs', 'embed-any-document' ); ?></a>
				</li>
			</ol>
		</div>
	</div><!-- .ead-right-wrap -->
